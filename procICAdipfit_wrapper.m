...
p.chNoEOG = [10:11 14:16 19:21 24:26 28:64 73:75 79:81 84:87 90:92 95:98 100:128]; % scalp channels with little ocular contamination
...
p.ICAi.kVal = 30; % K-value in determining number of ICA components (default = 25)
...
% ICA component rejection options
    % .measure = enable (1) or disable (0)
    % .z = Z-score cutoff
p.CRi.on = 1; % enable (1) or disable (0)
p.CRi.o.measure(1) = 0; % Median Gradient
p.CRi.o.z(1) = 3;
p.CRi.o.measure(2) = 0; % Slope around LPF band
p.CRi.o.z(2) = 3;
p.CRi.o.measure(3) = 0; % Spatial Kurtosis
p.CRi.o.z(3) = 3;
p.CRi.o.measure(4) = 0; % Hurst Exponent
p.CRi.o.z(4) = 3;
p.CRi.o.measure(5) = 1; % EOG/ECG correlation
p.CRi.o.z(5) = 3;
...
p.ICAf.kVal = 25; % K-value in determining number of ICA components (default = 25)
...
p.CRf.o.z(1) = 6;
p.CRf.o.measure(2) = 1; % Slope around LPF band
p.CRf.o.z(2) = 6;
...
p.hdmfile = '/home/kevinalt/MATLAB/eeglab13_5_4b/plugins/dipfit2.3/standard_BESA/standard_BESA.mat';
p.mrifile = '/home/kevinalt/MATLAB/eeglab13_5_4b/plugins/dipfit2.3/standard_BESA/avg152t1.mat';
p.chanfile = '/home/kevinalt/MATLAB/eeglab13_5_4b/functions/resources/Standard-10-5-Cap385_noEx.elp';
